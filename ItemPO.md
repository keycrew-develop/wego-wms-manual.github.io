...
2. サイドメニューの入荷(S)から入荷予定 一括入荷処理(S19)を開きます。
...
4. 画面右側の登録欄について説明します。
   ...
   2. 消費期限
      1. 入荷商品の消費期限を登録できます。
   3. 商品サイズ(※必須)
      1. 保管料を請求するため、商品サイズを登録します。画面右側の[縦][横][高]の欄に商品の三辺サイズを入力し[更新]ボタンをクリックします。荷主様が商品サイズを登録していない場合は
   4. 付帯作業
      1. 入荷商品に対して行う流通加工を登録出来ます。チェックボックスを選択肢[更新]ボタンをクリックするとその内容で付帯作業が一括登録されます。(元々登録されていた付帯作業もこの時に選択してください)
   5. 発注進捗
