...
5.  グループを作成する方法は3種類あります。
    1.  左枠の出荷グループ作成の行で作成
        ...
        4. 左枠の出荷グループ名に追記され、グループが作成されたことが分かります。![左枠から出荷グループ作成完了](/img/Ship/N10_ShippingGroupDone_leftUI.png)
    2.  オーダー明細から作成
    ...
    3. パターン明細から作成
       ...
       2. 右枠の[パターン明細]の画面から指定したいパターン件数を選択します。件数は画像緑枠の件数を参照ください。画像の例だと2件と選択しているのでパターンNo100,101がグループ作成されます。
       3. [グループ新規作成]の欄に分かりやすい出荷グループ名を入力します。
